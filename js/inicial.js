function getUser() {
    ...
    $.ajax({
        type: 'GET',
        //url: 'http://localhost:8080/api/user/' + id,     129.151.110.23
        url: 'http://129.151.110.23:8080/api/user/' + id,
        dataType: 'json',
...
function getOrders() {
    ...
    $.ajax({
        type: 'GET',
        //url: 'http://localhost:8080/api/orders/' + id,     129.151.110.23
        url: 'http://129.151.110.23:8080/api/orders/' + id,
        dataType: 'json',
        success: function(data) {
            var $row = $('<tr>');
...
$("#btnProductos").click(function() {
    localStorage.clear();
    window.location.href = "../pages/registroProductos.html";
});
